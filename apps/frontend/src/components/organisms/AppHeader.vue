  ...
  <header class="layout-header">
    <div class="layout-header__inner">
      <div class="layout-header__bar">
        <button
          type="button"
          class="layout-header__toggle"
          :class="{ 'layout-header__toggle--active': isMobileOpen }"
          @click="handleToggle"
        >
          <svg
            v-if="isMobileOpen"
            class="layout-header__toggle-icon"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
      ...
      >
        <div class="layout-header__actions">
          <button
            ...
            @click="router.push('/visual-editor')"
            title="Editor Visual"
          >
          ...
          <button
            class="header-icon-btn"
            @click="router.push('/notifications-history')"
